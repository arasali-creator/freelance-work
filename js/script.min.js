jQuery(document).ready(function() {
    ...
    },
    {
        ...
        link: "#",
        position: "CFO Advisor",
        short: "Mike joined our team in early 2023 and brings substantial Operations experience to our portfolio.  Prior to joining ASM, Mike headed up Operations in support of major aerospace projects at GE Aviation and PCC Aerostructures to name a few.  He brings significant experience in business turnarounds, growth strategies, implementing corporate infrastructure as well as roll-ups and mergers.  His extensive knowledge of manufacturing processes has been called upon to support production of the International Space Station as well as many other military and commercial aircraft.",
    },
    {
        photo: "../../img/photos/photo-0.png",
        name: "Jules Brenner",
    ...
    jQuery("[data-video]").on("click", function() {
        ...
        const n = jQuery("#info");
        n.find("[data-photo]").attr("src", o[e].photo), n.find("[data-name]").text(o[e].name), n.find("[data-link]").attr("href", o[e].link), n.find("[data-short]").text(o[e].short);
        let a = "";
